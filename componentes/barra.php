          ...
          <li class="dropdown">
            <a href="" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
              ...
              <ul class="dropdown-menu">
                ...
                ?>
                <li><a target="navegador" href="../ajuda.php">Ajuda</a></li>
                <li><a target="navegador" href="../reportar.php">Reportar um Erro</a></li>
                <li><a target="navegador" href="../sobre.php">Sobre o ConsuCloud</a></li>
                ...
                if($_SESSION["isMedico"] == true){
                  ...
                  echo '<li role="separator" class="divider"></li>';
                  echo '<li><a target="navegador" href="../agenda.php">Agenda</a></li>';
                  echo '<li><a target="navegador" href="../historico/historico_secretaria.php">Histórico de Consultas (Secretária)</a></li>';
                  echo '<li><a target="navegador" href="../historico/historico_medico.php">Histórico de Consultas (Médico)</a></li>';
                  echo '<li><a target="navegador" href="../relatorio/relatorio.php">Relatório de Consultas</a></li>';
                }
                ?>
