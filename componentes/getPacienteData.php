...
echo "RG: " . $RG . "-" . $RGUFEXP . "<br>Data de Nascimento: " . $dataNasc . "<br>Profissão: " . $profissao . "<br>Endereço: " . $endereco_logradouro . " " . $endereco_numero . " " . $endereco_complemento . " - " . $endereco_bairro . " - " .  $endereco_cidade  . " - " . $endereco_estado;
