...
if(stripos($_SERVER["HTTP_USER_AGENT"], 'Trident')) {
  ...
  echo '<div class="alert alert-info" id="rcorners2" role="alert"><b>O ConsuCloud está em testes com o Firefox. Em caso de problemas acesse o menu Reportar um Erro.</div>';
}
