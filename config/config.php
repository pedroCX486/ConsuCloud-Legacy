      ...
      <div class="jumbotron">
        ...
        <p>
          ...
          <form method="post" action="salvar.php" enctype="multipart/form-data">
                ...
                <div id="collapse1" class="panel-collapse collapse">
                  <div class="panel-body">
                    ...
                    <div class="input-group">
                      ...
                      <input required type="text" class="form-control" name="telefone" aria-describedby="basic-addon1" maxlength="100" value="<?php echo $telefone; ?>" placeholder="(00) 1234-5678 e (00) 1234-5678">
                    </div>
                ...
                <div id="collapse2" class="panel-collapse collapse">
                  <div class="panel-body">
                    ...
                    <div class="input-group">
                      ...
                      <input required type="text" class="form-control" name="endereco_logradouro" aria-describedby="basic-addon1" maxlength="150" value="<?php echo $endereco_logradouro; ?>">
                    </div>
            ...
            <center><button type="submit" class="btn btn-raised btn-primary btn-lg">SALVAR CONFIGURAÇÕES</button></center>
