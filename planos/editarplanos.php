        ...
        <div class="cadastro">
          ...
          <form method="post" action="editar.php">
            ...
            <div class="input-group">
              ...
              <input required type="text" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control" name="telFixo" aria-describedby="basic-addon1" placeholder="00 12345678" maxlength="11" OnKeyPress="formatar('## ########', this)" value="<?php echo $telFixo; ?>">
            </div>

            <div class="input-group">
              <span class="input-group-addon" id="basic-addon1">Email:*</span>
              <input required type="text" class="form-control" name="email" aria-describedby="basic-addon1" value="<?php echo $email; ?>" maxlength="150">
            </div>

            <div class="input-group">
              <span class="input-group-addon" id="basic-addon1">Informação sobre:*</span>
              <input required type="text" class="form-control" name="infoPlano" aria-describedby="basic-addon1" value="<?php echo $infoPlano; ?>" maxlength="200">
            </div>
                ...
                <div id="collapse1" class="panel-collapse collapse">
                  <div class="panel-body">
                    ...
                    <div class="input-group">
                      ...
                      <input required type="text" class="form-control" name="endereco_numero" aria-describedby="basic-addon1" value="<?php echo $endereco_numero; ?>" maxlength="10">
                    </div>
