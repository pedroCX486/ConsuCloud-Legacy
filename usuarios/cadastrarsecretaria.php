...
<body>
    ...
    <div class="container">
      <div class="jumbotron">
        <h1><small>Cadastrar Secretária</small></h1><br>
        <div class="cadastro">
          ...
          <form method="post" action="cadastrar.php">
            ...
            <div class="input-group">
              ...
              <input required type="text" class="form-control validate" name="crm" id="cpf" aria-describedby="basic-addon1" maxlength="11" onKeyPress="return event.charCode >= 48 && event.charCode <= 57" pattern="[0-9]{11}" title="Digite sem traços, pontos e todos os 11 dígitos. Exemplo: 99999999999">
            </div>
            ...
            <div class="input-group">
              ...
              <input required type="text" class="form-control" id="email" name="email" aria-describedby="basic-addon1" maxlength="100" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="exemplo@exemplo.com">
            </div>

            <div class="input-group">
              <span class="input-group-addon" id="basic-addon1">Nome Curto:*</span>
              <input required type="text" class="form-control" name="nomeCurto" aria-describedby="basic-addon1" placeholder="Para exibição no sistema, exemplo: Scr. Maria Joséfa" maxlength="25">
            </div>
