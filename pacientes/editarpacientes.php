...
<body>
    ...
    <div class="container">
      <div class="jumbotron">
        <h1><small>Editar Pacientes</small></h1><br>
        <div class="cadastro">
          ...
          <form method="post" action="editar.php">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control" name="email" aria-describedby="basic-addon1" value="<?php echo $email; ?>" maxlength="100" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="exemplo@exemplo.com">
            </div>
