...
Aviso:  
Revisar se aplicação deve usar HTTP ou HTTPS baseado [neste commit](https://github.com/pedroCX486/ConsuCloud/commit/5cf19ccca8024ae47df48930701d8f7b3b6a0607). (AKA: Editar no redirect.php para HTTP ou HTTPS dependendo do que o servidor da aplicação suportar/for usar.)
