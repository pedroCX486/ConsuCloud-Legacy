          ...
          <div class="form-group" style="width: 500px;">
            <p>
              ...
              <div class="input-group">
                ...
                <input required value="<?php echo $dataFim ?>" type="date" class="form-control" name="dataFim" aria-describedby="basic-addon1"
                  max="9999-12-31" maxlength="10" OnKeyPress="formatar('##/##/####', this)">
              </div>
        ...
        <form method="post" action="gerar.php" target="_blank">
          ...
          <p>
            <h5>
              ...
              <span class="glyphicon glyphicon-thumbs-down" aria-hidden="true"></span>) não serão exibidas no relatório final.</h5>
          </p>
